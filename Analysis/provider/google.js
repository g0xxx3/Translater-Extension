...
(function() {
    ...
    function _loadJs(b) {
        ...
        a.onerror = function(){ 
            if(!loaderror) {
                swal({title: 'Translate Error', text: 'Script load error. Network issue (Are you in Mainland China? Maybe you should do something to access google.com) or CSP blocked. \n脚本加载失败。 网络错误（您是否在中国大陆？也许您需要一些方法来访问 Google）或是 CSP 阻挡。', type: 'error'})
            }
            loaderror = true
        };
        d(a)
